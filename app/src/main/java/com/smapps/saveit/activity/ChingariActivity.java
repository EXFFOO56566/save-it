...
import static com.smapps.saveit.util.Utils.ROOTDIRECTORYCHINGARI;
...
public class ChingariActivity extends AppCompatActivity {
    ...
    private void initViews() {
        clipBoard = (ClipboardManager) activity.getSystemService(CLIPBOARD_SERVICE);
        binding.head.tvTitle.setText(activity.getResources().getString(R.string.chingari_app_name));
        binding.head.imAppLogo.setVisibility(View.VISIBLE);
        binding.head.imAppLogo.setImageResource(R.drawable.chingari);
        ...
        binding.tvOptionName.setText(activity.getResources().getString(R.string.chingari_app_name));
