...
import com.smapps.saveit.adapter.ShowImagesAdapter;
import com.smapps.saveit.databinding.ActivityFullViewBinding;
...
import static com.smapps.saveit.util.Utils.shareImage;
import static com.smapps.saveit.util.Utils.shareImageVideoOnWhatsapp;
import static com.smapps.saveit.util.Utils.shareVideo;
...
public class FullViewActivity extends AppCompatActivity {
    ...
    public void initViews(){
        ...
        binding.LLWhatsappShare.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (fileArrayList.get(Position).getName().contains(".mp4")){
