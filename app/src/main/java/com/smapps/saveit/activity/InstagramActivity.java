...
import com.smapps.saveit.adapter.StoriesListAdapter;
import com.smapps.saveit.adapter.UserListAdapter;
...
import com.smapps.saveit.model.Edge;
import com.smapps.saveit.model.EdgeSidecarToChildren;
import com.smapps.saveit.model.FBStoryModel.NodeModel;
import com.smapps.saveit.model.ResponseModel;
...
public class InstagramActivity extends AppCompatActivity implements UserListInterface {
    ...
    private void initViews() {
        ...
        binding.head.tvTitle.setText(activity.getResources().getString(R.string.insta_app_name));
        binding.head.imAppLogo.setVisibility(View.VISIBLE);
        binding.head.imAppLogo.setImageResource(R.drawable.insta_logo);
       ...
       layoutHowToBinding.tvHowTo3.setText(getResources().getString(R.string.copy_video_link_from_insta));
        ...
        binding.tvOptionName.setText(activity.getResources().getString(R.string.insta_app_name));
        ...
        binding.LLLoginInstagram.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (!SharePrefs.getInstance(activity).getBoolean(SharePrefs.ISINSTALOGIN)) {
