...
import static com.smapps.saveit.util.Utils.ROOTDIRECTORYJOSH;
...
public class JoshActivity extends AppCompatActivity {
    ...
    private void initViews() {
        clipBoard = (ClipboardManager) activity.getSystemService(CLIPBOARD_SERVICE);
        binding.head.tvTitle.setText(activity.getResources().getString(R.string.josh_app_name));
        binding.head.imAppLogo.setVisibility(View.VISIBLE);
        binding.head.imAppLogo.setImageResource(R.drawable.josh_logo);
        ...
        binding.tvOptionName.setText(activity.getResources().getString(R.string.josh_app_name));
