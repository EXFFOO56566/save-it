...
import static com.smapps.saveit.util.Utils.ROOTDIRECTORYMOJ;
...
public class MojActivity extends AppCompatActivity {
    ...
    private void initViews() {
        clipBoard = (ClipboardManager) activity.getSystemService(CLIPBOARD_SERVICE);
        binding.head.tvTitle.setText(activity.getResources().getString(R.string.moj_app_name));
        binding.head.imAppLogo.setVisibility(View.VISIBLE);
        binding.head.imAppLogo.setImageResource(R.drawable.moj);
        ...
        binding.tvOptionName.setText(activity.getResources().getString(R.string.moj_app_name));
        ...
        layoutHowToBinding.tvHowTo1.setText(getResources().getString(R.string.open_moj));
        layoutHowToBinding.tvHowTo3.setText(getResources().getString(R.string.cop_link_from_moj));
