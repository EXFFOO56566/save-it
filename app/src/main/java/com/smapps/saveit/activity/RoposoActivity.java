...
import static com.smapps.saveit.util.Utils.RootDirectoryRoposo;
...
public class RoposoActivity extends AppCompatActivity {
    ...
    private void initViews() {
        clipBoard = (ClipboardManager) activity.getSystemService(CLIPBOARD_SERVICE);
        binding.head.tvTitle.setText(activity.getResources().getString(R.string.roposo_app_name));
        binding.head.imAppLogo.setVisibility(View.VISIBLE);
        binding.head.imAppLogo.setImageResource(R.drawable.ic_roposo);
        ...
        binding.tvOptionName.setText(activity.getResources().getString(R.string.roposo_app_name));
        ...
        layoutHowToBinding.tvHowTo1.setText(getResources().getString(R.string.opn_roposo));
        layoutHowToBinding.tvHowTo3.setText(getResources().getString(R.string.copy_video_link_frm_roposo));
