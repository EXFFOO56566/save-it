...
import static com.smapps.saveit.util.Utils.RootDirectoryTwitter;
...
public class TwitterActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        binding.head.tvTitle.setText(activity.getResources().getString(R.string.twitter_app_name));
        binding.head.imAppLogo.setVisibility(View.VISIBLE);
        binding.head.imAppLogo.setImageResource(R.drawable.ic_twitter);
        ...
        binding.tvOptionName.setText(activity.getResources().getString(R.string.twitter_app_name));
        ...
        layoutHowToBinding.tvHowTo1.setText(getResources().getString(R.string.open_twitter));
        layoutHowToBinding.tvHowTo3.setText(getResources().getString(R.string.copy_video_link_from_twitter));
